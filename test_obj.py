...
convd3_sl_obj = Soft_Label_Objective(dataset="CIFAR10", real_data_path="./dataset", ipc=10, model_name="ConvNet-3")
print(convd3_sl_obj.compute_metrics(syn_images, syn_labels, syn_lr))

convd3_kl_obj = KL_Divergence_Objective(dataset="CIFAR10", real_data_path="./dataset", ipc=10, model_name="ConvNet-3")
