...
convd3_kl_obj = KL_Divergence_Objective(dataset=dataset, real_data_path=data_dir, ipc=ipc, model_name=model_name, device=device)
print(convd3_kl_obj.compute_metrics(syn_images, syn_lr=syn_lr))
